...
class UserManager:
    ...
    def __init__(self, filepath: str = "users.json", unknown_questions_file: str = "unknown_questions.json"):
    ...
    def _load_unknown_questions(self):
        """Загружает неизвестные вопросы из файла"""
    ...
    def _save_unknown_questions(self):
        """Сохраняет неизвестные вопросы в файл"""
        try:
    ...
    def get_user_unknown_questions(self, user_id: int) -> List[Dict]:
        ...
        user_data = self.get_user(user_id)
        return user_data.get("unknown_questions", [])

    def get_unknown_questions_stats(self) -> Dict:
        """Статистика по неизвестным вопросам"""
